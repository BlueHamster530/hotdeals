...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("5G 라우터 무선 공유기", "전자기기"),
        # 무게 단위 'N5g'(15g/85g/175g 등)에 '5g'가 substring으로 걸려 요금제로 오분류되던
        # 버그 (실제 서버 DB에서 다수 발견, 2026-07-08)
        ("[G마켓] 폭풍 컵떡볶이 구멍쌀떡 175g 8개 (26,220원/무배)", "식품"),
        # bare 'kt'는 통신 무관 제휴 이벤트에도 흔해 요금제로 오분류하지 않음 (실제 잡았던 버그)
        ("[kt멤버십] 풀무원샘물 2L 24병", None),
